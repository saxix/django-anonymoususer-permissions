...
class DjangoHTMLTranslator(HTMLTranslator):
    ...
    version_text = {
        'deprecated': 'Deprecated in Django AnonymousUser Permissions %s',
        'versionchanged': 'Changed in Django AnonymousUser Permissions %s',
        'versionadded': 'New in Django AnonymousUser Permissions %s',
    }
